...
SkillInfoUI::SkillInfoUI() : GameObject("Skill Info UI", Layer::Menu) {
	...
	frame = new GameObject("Skill Board Frame", Layer::Menu);
	...
	iconFrame = new GameObject("Skill Info Icon Frame", Layer::Menu);
	...
	buyButton = new GameObject("Skill Info Button", Layer::Menu);
	...
	buttonCostLabel = new GameObject("Skill Info Cost Label", Layer::Menu);
	...
	buttonIcon = new GameObject("Skill Info Icon Frame", Layer::Menu);
	...
	skillLabel = new GameObject("Skill Label", Layer::Menu);
	...
	skillDescription = new GameObject("Skill Description", Layer::Menu);
	...
	frameUnselected = new GameObject("Skill Info Frame Unselected", Layer::Menu);
	...
	frameUnselectedMessage = new GameObject("Skill Info Frame Unselected Message", Layer::Menu);
